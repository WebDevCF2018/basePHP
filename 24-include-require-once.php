...
<p>Ne pas utiliser pour des données sensibles. Il est souvent utilisé pour charger des parties graphiques de page (menu, header, footer etc..), particulièrement si on doit les charger plusieurs fois (les menus)</p>
<?php
...
<p>Lorsqu'on travaille à plusieurs, on ne sait pas nécessairement si quelq'un d'autre a déja importé le fichier, on évite ainsi les doubles inclusions</p>
<h3>require</h3>
